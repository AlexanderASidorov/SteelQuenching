...
text('data_max_grain_size_7.txt') # write data necessary for FlowVision simulation
results = results2text(data, 'results_max_grain_size_7.txt') # write final phase composition
